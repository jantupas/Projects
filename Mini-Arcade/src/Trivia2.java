...
public class Trivia2 extends javax.swing.JFrame {
    ...
    public void question1(){
            aveQues.setText("What is the name of the oldest city in the Philippines?");
            op1.setText("Manila City");
            op2.setText("Cebu City");
            op3.setText("Bacolod City");   
            op4.setText("Iloilo City");         
    }
    public void question2(){
            aveQues.setText("What country invaded the Philippines during World War II?");
            op1.setText("America");
            op2.setText("China");
            op3.setText("Japan");   
            op4.setText("Germany");   
    ...
    public void question3(){
            aveQues.setText("When did the Bataan Death March happen?");
            op1.setText("April 9, 1942");
            op2.setText("March 12, 1941");
            op3.setText("February 8, 1942");   
            op4.setText("January 7, 1941");       
    }
    public void question4(){
            aveQues.setText("What city is the sugarcane capital of the Philippines?");
            op1.setText("Makati City");
            op2.setText("Davao City");
            op3.setText("Quezon City");   
            op4.setText("Bacolod City");
    }
    public void question5(){
            aveQues.setText("Who opposed Andres Bonifacio during the Tejeros Convention");
            op1.setText("Pedro Paterno");
            op2.setText("Daniel Terona");
            op3.setText("Heneral Miguel Malvar");   
            op4.setText("Padre Pedro Pelaez");        
    }
    ...
    private void initComponents() {
        ...
        aveQues = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        triviaMenu = new javax.swing.JMenuBar();
        difficulty = new javax.swing.JMenu();
        triv2Easy = new javax.swing.JMenuItem();
        triv2Ave = new javax.swing.JMenuItem();
        triv2Hard = new javax.swing.JMenuItem();
        ...
        aveQues.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        aveQues.setText("Who was the first president of the Philippines?");
        jPanel2.add(aveQues, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, -1));
        ...
        triv2Easy.setText("Easy");
        triv2Easy.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                triv2EasyActionPerformed(evt);
            }
        });
        difficulty.add(triv2Easy);

        triv2Ave.setText("Medium");
        triv2Ave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                triv2AveActionPerformed(evt);
            }
        });
        difficulty.add(triv2Ave);

        triv2Hard.setText("Hard");
        triv2Hard.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                triv2HardActionPerformed(evt);
            }
        });
        difficulty.add(triv2Hard);
        ...
        public void go(){
            TimerTask task = new triviaTimer2(this);
            timer = new Timer();
    ...
    private void triv2EasyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_triv2EasyActionPerformed
                timer.cancel();
                Trivia trivia = new Trivia();
                trivia.show();
        
                dispose();
    }//GEN-LAST:event_triv2EasyActionPerformed

    private void triv2AveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_triv2AveActionPerformed
                timer.cancel();
                Trivia2 trivia2 = new Trivia2();
                trivia2.show();
        
                dispose();
    }//GEN-LAST:event_triv2AveActionPerformed

    private void triv2HardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_triv2HardActionPerformed
                timer.cancel();
                Trivia3 trivia3 = new Trivia3();
                trivia3.show();
        
                dispose();
    }//GEN-LAST:event_triv2HardActionPerformed
    ...
    private javax.swing.JLabel aveQues;
    ...
    private javax.swing.JMenuItem triv2Ave;
    private javax.swing.JMenuItem triv2Easy;
    private javax.swing.JMenuItem triv2Hard;
