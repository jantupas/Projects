...
CREATE TABLE `transactions` (
  ...
  `Ord_ID` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`Trans_ID`),
  KEY `C_ID` (`C_ID`),
  KEY `Prod_ID` (`Prod_ID`),
  CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`C_ID`) REFERENCES `customer` (`C_ID`),
  CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`Prod_ID`) REFERENCES `product` (`Prod_ID`)
